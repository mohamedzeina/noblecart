        ...
        <a class="search-suggestion" href="/products/${p._id}">
          ...
          <div class="search-suggestion__text">
            ...
            <div class="search-suggestion__meta">
              ${escHtml(categoryLabel(p.category))}
              ${p.rating ? `<span class="search-suggestion__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="10" height="10" aria-hidden="true" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>${p.rating.avg.toFixed(1)}</span>` : ''}
            </div>
          </div>
